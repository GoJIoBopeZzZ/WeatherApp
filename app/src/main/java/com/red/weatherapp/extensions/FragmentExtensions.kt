...
fun Fragment.replace(fragmentManager: FragmentManager?, @IdRes containerId: Int, tag: String,
                     transition: Int = FragmentTransaction.TRANSIT_FRAGMENT_OPEN) {
    fragmentManager?.beginTransaction()
            ?.setTransition(transition)
...
fun Fragment.replace(activity: FragmentActivity?, @IdRes containerId: Int, tag: String,
                     transition: Int = FragmentTransaction.TRANSIT_FRAGMENT_OPEN) {
